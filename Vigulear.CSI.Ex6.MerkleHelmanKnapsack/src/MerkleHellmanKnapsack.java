...
public class MerkleHellmanKnapsack {
    ...
    private static final Charset UTF8 = StandardCharsets.UTF_8;  // the program only processes UTF-8 encoded messages
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Length of encrypted message = " + encrypted.length());
